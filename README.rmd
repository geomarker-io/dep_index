...
```{r echo=F, fig.width=12, message=FALSE, warning=FALSE}
source('figs/nationwide_map.r')
national_map
```

Below is an example of how the index looks across the Greater Cincinnati, Ohio area:
